...
// 0.1.0: persistent, URL-keyed memory for pages the user reads in BOSS.
// Notes, tags, related URLs and cross-plugin references per URL.
version = "0.1.0"
...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-page-memory-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Page Memory Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.pagemem.PageMemoryDynamicPlugin",
        )
    }
